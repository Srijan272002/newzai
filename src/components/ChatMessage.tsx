  ...
  return (
    <div className={`flex items-start ${isUser ? 'justify-end' : 'justify-start'}`}>
      <div
        className={`${
          isUser
            ? 'glass-effect-dark text-primary-white rounded-card py-md px-lg max-w-[80%]'
            : 'glass-effect rounded-card py-md px-lg max-w-[80%] text-gray-dark'
      ...
      >
        ...
        <div className={`text-small mt-sm text-right ${isUser ? 'text-white/50' : 'text-black/40'}`}>
